...
const contentData = {
  ...
  sectionThree: {
    ...
    content: [
      {
        title: "By the end of the program, you will:",
        bullet: [
          "Design, test, and launch an intervention with an NGO.",
          "Create a self-sustaining product or service.",
          "Measure real impact metrics: from behavior change to usability and reach.",
          "Leave with proof your solution works.",
        ],
      },
    ],
  },
  sectionFour: [
    {
      ...
      title: "Start Dates",
      description: "15 Oct • 1 Nov • 15 Nov • 1 Dec • 10 Dec • 5 Jan • 15 Jan",
    },
    {
    ...
    },
    {
      ...
      title: "Fee",
      description: "Rs. 38,000 + gst",
    },
    {
      image: "/assets/assets/professionals/eligibility.svg",
      title: "Eligibility",
      description: "15–20 years old • Must be a student",
    },
  ],
  sectionFive: {
    ...
    <div className="overflow-hidden relative flex flex-col  items-center justify-center">
        ...
        <div className=" max-w-6xl mx-auto flex flex-col  items-center justify-center  lg:flex-row gap-4 lg:gap-8 p-5">
          {contentData?.sectionFour?.map((curr, i) => {
            return (
              <div
                key={i}
                className={`p-5 py-10 justify-between border rounded-md lg:rounded-lg w-full lg:w-[271px] lg:h-[271px] flex flex-col items-center  max-w-sm mx-auto  laspect-square  ${i % 2 === 0 ? "bg-white" : "bg-[#FFFDF1]"
                  }`}
              >
                <div className="p-5">
      ...
      <AnimatedBox className="bg-white w-full py-[20px] lg:py-[40px]">
        <div className="max-w-6xl mx-auto flex flex-col gap-4 lg:gap-8  my-5 px-5 ">
          ...
          <AnimatedBox className=" font-semibold text-[14px] lg:text-[20px] font-mulish  lg:leading-[30px] text-center">
            {contentData?.sectionFive?.description2}
          </AnimatedBox>
          <div className="flex justify-center gap-2 lg:gap-5 items-center">
            <ApplyNowButton url="https://docs.google.com/forms/d/e/1FAIpQLSfTD4szAOBoJ9CC2xMsOEIst2W0BbQ34LhvM58zODiRJDOB7Q/viewform" />
